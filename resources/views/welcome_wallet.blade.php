    ...
    <section id="header">
        <div class="container">
            <div class="row text-center">
                <div class="col-md-8">
                    <h1>𝒲𝒜𝐿𝐿𝐸𝒯</h1>
                    <h1 class="white-text">{{__('masseges.Welcome_first_wallet')}}</h1>
                    <h5 class="white-text" style="margin-bottom: 20px;">{{__('masseges.massage_To_start')}}</h5>
                    <form action="{{ url('first_user_wallet') }}">
                        <button class="button">
                            <span class="button__text">
                                {{-- <span>إ</span><span>ن</span>ش</span><span>ا</span><span>ء</span> --}}
